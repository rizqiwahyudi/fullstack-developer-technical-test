        ...
        <form enctype="multipart/form-data" id="form_employee">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="tanggal_lahir" id="tanggal_lahir"
                        placeholder="Tanggal Lahir" value="{{ date('m-d', strtotime($employee->tanggal_lahir)) }}">
                ...
                <div class="col">
                    ...
                    <select name="tahun_lahir" id="tahun_lahir" class="form-control">
                        ...
                        @php
                            ...
                            $temp_date = explode('-', $employee->tanggal_lahir);
                            $employee->tanggal_lahir = $temp_date[0];
                        @endphp
                        @foreach ($years as $year)
                            <option value="{{ $year }}" {{ $year == $employee->tanggal_lahir ? 'selected' : ''}}>{{ $year }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="departemen" id="departemen"
                        placeholder="Departemen" value="{{ $employee->departemen }}">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="phone" id="phone"
                        placeholder="No HP" value="{{ $employee->phone }}">
                ...
                <div class="col">
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="islam" value="islam" {{ $employee->agama == 'islam' ? 'checked' : '' }} name="agama">
                        <label for="islam" class="form-check-label">Islam</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="kristen_protestan" value="kristen protestan" {{ $employee->agama == 'kristen protestan' ? 'checked' : '' }} name="agama">
                        <label for="kristen_protestan" class="form-check-label">Kristen Protestan</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="katolik" value="katolik" {{ $employee->agama == 'katolik' ? 'checked' : '' }} name="agama">
                        <label for="katolik" class="form-check-label">Katolik</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="hindu" value="hindu" {{ $employee->agama == 'hindu' ? 'checked' : '' }} name="agama">
                        <label for="hindu" class="form-check-label">Hindu</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="budha" value="budha" {{ $employee->agama == 'budha' ? 'checked' : '' }} name="agama">
                        <label for="budha" class="form-check-label">Budha</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="konghucu" value="konghucu" {{ $employee->agama == 'konghucu' ? 'checked' : '' }} name="agama">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <textarea name="alamat" id="alamat" rows="5" class="form-control" placeholder="Alamat">{{ $employee->alamat }}</textarea>
            ...
            <div class="row mb-3 mt-5">
                <div class="col-lg-12 offset-lg-5">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="status" name="status" {{ $employee->status == 'active' ? 'checked' : ''}}>
